...
!   comparing each result with benchmark results in the file testmpfun.ref.txt,
!   which must be present in the same directory.  This is not an exhaustive
!   test of all possible scenarios, but it often detects bugs and compiler issues.
